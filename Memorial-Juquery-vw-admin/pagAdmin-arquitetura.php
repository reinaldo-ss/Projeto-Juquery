...
<body id="overflowFixedAdm">
      ...
      <li>
        <div class="dropdown">
          ...
          <div class="dropdown-contentAdm">
            ...
            <p> <a class="btnMenu activeLink" href="./pagAdmin-arquitetura.php" onclick="topFunction(); menuShow(); actionAdm()"> Arquitetura </a> </p>
          </div>
        </div>
      </li>
 ...
 <!-- ======================= CONTEUDO ======================= -->
  <div class="adm">
    ...
    <h2>Inserir em "Arquitetura"</h2>

    <form method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Arq.php">
      <p class="align-obj">Aqui poderá ser enviado ARQUITETURA do Juquery, ao final terá a escolha de publica-la ou não</p>
      ...
      <input type="text" id="text_subtitle" name="txtsub" placeholder="Inserir subtitulo" required>
      ...
      <input type="text" id="text_Font" name="txtlinkarq" placeholder="Inserir fonte / link da informação" required>
  ...
  if(isset($_GET['id_ex'])) {
    ...
    $envia->excluirArq($idexclui);
  }
  ?>

  <div class="adm">
    <h1>"Arquitetura" Inseridas</h1>
    <h2>Publicar Arquitetura</h2>
    ...
    <div class="publiContent">
      ...
      <div class="divPubli">
        <?php $consult = $envia->retornaArqImg();
        for ($i=0; $i < count($consult); $i++) { 
          if ($consult[$i]['Extatus'] == 0) {
            if($i%6 == 0) {
              ?>
              <form class="formPubli" method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Arq.php">
                <div class="publicacao">
                  ...
                  <div class="btnPubli">
                    <input hidden type="number" name="id" value="<?php echo $consult[$i]['idArq'];?>">
                    ...
                    <?php $idexclui = $consult[$i]['idArq'];?>
                    <a class="btnExcl" href='editarArq.php?id=<?php echo $consult[$i]['idArq'];?>'><i class="fa fa-lg fa-edit"></i></a>
                  </div>
                </div>
              </form>
              <?php 
