...
<body id="overflowFixedAdm">
      ...
      <li>
        <div class="dropdown">
          ...
          <div class="dropdown-contentAdm">
            ...
            <p> <a class="btnMenu activeLink" href="./pagAdmin-atualidades.php" onclick="topFunction(); menuShow(); actionAdm()"> Atualidades </a> </p>
 ...
 <!-- ======================= CONTEUDO ======================= -->
  <div class="adm">
    ...
    <h2>Inserir em "Atualidades"</h2>

    <form method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Atu.php">
      <p class="align-obj">Aqui poderá ser enviado Atualidades, ao final terá a escolha de publica-la ou não</p>
      ...
      <input type="text" name="txtdescricao" id="text_info" placeholder="Inserir texto">

      <label for="date">Data</label>
      <input type="date" name="txtdata" id="date" required>
      ...
      <input type="text" id="text_Font" name="txtfont" placeholder="Inserir fonte / link da informação" required>
  ...
  if(isset($_GET['id_ex'])) {
    ...
    $envia->excluirAtualidade($idexclui);
  }
  ?>

  <div class="adm">
    <h1>Atualidades Inseridas</h1>

    <h2>Publicar Atualidades</h2>
    ...
    <div class="publiContent">
      ...
      <div class="divPubli">
        <?php $consult = $envia->retornaAtuaImg();
        for ($i=0; $i < count($consult); $i++) { 
          if ($consult[$i]['Extatus'] == 0) {
            if($i%6 == 0){
              ?>
              <form class="formPubli" method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Atu.php">
                <div class="publicacao">
                  ...
                  <div class="btnPubli">
                    <input hidden type="number" name="id" value="<?php echo $consult[$i]['idAtua'];?>">
                    ...
                    <?php $idexclui = $consult[$i]['idAtua'];?>
                    <a class="btnExcl" href='editarAtua.php?id=<?php echo $consult[$i]['idAtua'];?>'><i class="fa fa-lg fa-edit"></i></a>
                  </div>
                </div>
              </form>
              <?php 
