...
<body id="overflowFixedAdm">
 ...
 <!-- ======================= CONTEUDO ======================= -->
  <div class="adm">
    ...
    <h2>Inserir em "Artistas"</h2>

    <form method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Art.php">
      <p class="align-obj">Aqui poderá ser enviado ARTISTAS, ao final terá a escolha de publica-lo(a) ou não</p>

      <label for="text_title">Título</label>
      <input type="text" name="text_title" id="text_title" placeholder="Inserir Título" required>
      ...
      <input type="text" name="text_subtitle" id="text_subtitle" placeholder="Inserir nome do compositor(es)" required>

      <label for="text_info">Link</label> <!-- Caminho p youtube-->
      <input type="text" name="text_info" id="text_info" placeholder="Inserir link do video">
  ...
  if(isset($_GET['id_ex'])) {
    ...
    $envia->excluirArt($idexclui);
  }
  ?>

  <div class="adm">
    <h1>Artistas Inseridos</h1>
    <h2>Publicar Artistas</h2>
      ...
      <div class="divPubli">
        ...
        for ($i=0; $i < count($consult); $i++) { 
          if ($consult[$i]['Extatus'] == 0) {
            if($i%6 == 0){
              ?>
              <form class="formPubli" method="post" enctype="multipart/form-data" action="../Memorial-Juquery/Controller/Ctl-Art.php">
                <div class="publicacao">
                  ...
                  <div class="btnPubli">
                    <input hidden type="number" name="id" value="<?php echo $consult[$i]['idVid'];?>">
                    ...
                    <?php $idexclui = $consult[$i]['idVid'];?>
                    <a class="btnExcl" href='editarArt.php?id=<?php echo $consult[$i]['idVid'];?>'><i class="fa fa-lg fa-edit"></i></a>
                  </div>
                </div>
              </form>
              <?php 
